...
\bi
  ...
  \item 53 Used surrogate marker as primary endpoint
\ei
...
"Reducing the costs of trials is absolutely crucial for the public good" -- Dr. Claiborne Johnston (UCSF) \cite{@Johnston:2006ju}
...
\vspace{0.2cm}
\bi
  \item Motivating Example: REACH Trial
  \item Paper 1: Sequential Rematched Randomization
  \item Paper 2: Adaptive Monitoring Using the Second Generation p-value
  \item Paper 3: sgpvAM R package and practical guidance to control adaptive monitoring errors
\ei
...
\vspace{0.3cm}
$^{\ast}$ Greater association with outcome
...
Where Stratified and Matched randomization adjusts for
  \bi
    \item Site, Baseline A1c, DM Type, and Time since DM Dx (Adj )
    \item All baseline covariates (3m A1c Adj $R^2 = 0.46$)
  \ei
...
% \begin{frame}[fragile]{ }
% \figw{\string~/Dropbox/statistics/work/vandy/RandomizationMethods/ExtendingMOTF/FigsRefs/visualPresentations/MaxSMD_uu}{.825}
% \end{frame}

\begin{frame}[fragile]{ }
\figw{\string~/Dropbox/statistics/work/vandy/RandomizationMethods/ExtendingMOTF/FigsRefs/visualPresentations/AveSMD_uu}{.825}
\end{frame}



\begin{frame}[fragile]{ }
\figw{\string~/Dropbox/statistics/work/vandy/RandomizationMethods/ExtendingMOTF/FigsRefs/visualPresentations/modelAdjCIwidth_uu}{.825}
\end{frame}

% \begin{frame}[fragile]{ }
% \figw{\string~/Dropbox/statistics/work/vandy/RandomizationMethods/ExtendingMOTF/FigsRefs/visualPresentations/permutationCIwidth_uu}{.825}
% \end{frame}

\begin{frame}[fragile]{ }
\figw{\string~/Dropbox/statistics/work/vandy/RandomizationMethods/ExtendingMOTF/FigsRefs/visualPresentations/permutationCIwidth_uu2}{.825}
\end{frame}
...
%\begin{center}\animategraphics[autoplay,height=4cm,every=1]{65}{\string~/Dropbox/statistics/work/vandy/AdaptiveMonitoring/Conferences/SCT/slides/mu00exampleSeed7_}{1}{1}\end{center}
...
\bi
  {\setlength\itemindent{15pt}\item[Wait] interval width stabilizes}
	{\setlength\itemindent{15pt}\item[Monitor] interval and SGPV at desired looks}
	{\setlength\itemindent{15pt}\item[Alert] SGPV$_{T}$ = 0.0: Ruled out trivial effects}
	{\setlength\itemindent{15pt}\item[] SGPV$_{M}$ = 0.0: Ruled out highly actionable effects}
	{\setlength\itemindent{15pt}\item[Affirm] stop if same conclusion [40] patients later}
	{\setlength\itemindent{15pt}\item[] end of resources (n = 512)}
	{\setlength\itemindent{15pt}\item[Report] only the final interval when stopping}
\ei
...
%\begin{center}\animategraphics[autoplay,height=4cm,every=5]{65}{\string~/Dropbox/statistics/work/vandy/AdaptiveMonitoring/Conferences/SCT/slides/slidesmu07example}{2}{257}\end{center}
